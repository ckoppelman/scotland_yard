...
/** Small pawn picture used inside privacy / intro modals (not the draggable map token). */
export function PrivacyModalPawn({ player, size }: Props) {
    ...
    return (
        <svg className="privacy-modal__pawn" width={spec.w} height={spec.h} viewBox={spec.vb} aria-hidden>
